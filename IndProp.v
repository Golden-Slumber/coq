...
Proof.
  intros E.
  inversion E. inversion H0. inversion H2. Qed.
...
Proof.
  ...
  - rewrite <- plus_n_Sm. rewrite <- plus_n_Sm. apply ev_SS. apply IHE2. Qed.
(** [] *)
...
Theorem succ_succ_n : forall n, S(S n) = n + 2.
Proof.
...
Proof.
  ...
  - intros. induction H.
    + apply ev'_0.
    + rewrite succ_succ_n. apply ev'_sum.
      apply IHev. apply ev'_2. Qed.
(** [] *)
...
Proof.
  ...
  - rewrite plus_comm in E1. rewrite <- plus_n_Sm in E1. rewrite <- plus_n_Sm in E1.
    apply IHE2. inversion E1. rewrite plus_comm in H0. apply H0. Qed.
(** [] *)
...
Inductive total_relation : nat -> nat -> Prop :=
  | nm : forall n m:nat, total_relation n m.
(** [] *)
...
Proof.
  ...
  - inversion E.
    + apply le_n.
    + apply le_S. apply IHm. apply H0. Qed.
...
Proof.
  ...
  - split.
    ...
    + destruct IHle. apply le_S. apply H1. Qed.
  (*unfold lt.
  intros n1 n2 m E. split.
  - induction m.
    + inversion E.
    + inversion E.
      * rewrite plus_comm. rewrite plus_n_Sm. rewrite plus_comm. apply le_plus_l.
...
Proof.
  ...
  - intros. destruct n.
    ...
    + simpl in H. apply n_le_m__Sn_le_Sm. apply IHm. apply H. Qed.
...
Proof.
  ...
  - intros. destruct n.
    + reflexivity.
    + inversion H.
      * simpl. apply IHm. apply le_n.
      * apply IHm. apply Sn_le_Sm__n_le_m. apply H. Qed. 
...
Proof.
  ...
  - intros. induction H.
    ...
    + simpl in IHR. inversion IHR. unfold fR in H1. rewrite <- plus_n_Sm in H1.
      inversion H1. reflexivity.
    + unfold fR. unfold fR in IHR. rewrite plus_comm. apply IHR.
  - intros. unfold fR in H. generalize dependent m. generalize dependent n. induction o.
    + intros. apply and_exercise in H. destruct H. rewrite H. rewrite H0. apply c1.
    + intros. destruct m.
      * simpl in H. rewrite H. apply c3. apply IHo. reflexivity.
      * inversion H. apply c2. rewrite H1. apply IHo. apply H1. Qed.
