...
Proof.
  ...
  - reflexivity.
  - simpl. rewrite -> IHh. reflexivity. Qed.

Theorem app_assoc : forall A (l m n:list A),
  l ++ m ++ n = (l ++ m) ++ n.
Proof.
  intros A l m n. induction l as [| t h IHh].
  - reflexivity.
  - simpl. rewrite -> IHh. reflexivity. Qed.
...
Proof.
  ...
  induction l.
  - simpl. reflexivity.
  - simpl. rewrite map_app. simpl. rewrite IHl. reflexivity. Qed.
(** [] *)
...
Proof.
  intros.
  unfold fold_length. induction l.
  - simpl. reflexivity.
...
Proof.
  intros X Y Z f x y.
  unfold prod_uncurry.
  unfold prod_curry. simpl. reflexivity. Qed.
