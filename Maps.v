...
Proof.
  ...
  intros x0. destruct (beq_string x x0).
  - reflexivity.
  - reflexivity. Qed.
(** [] *)
...
Proof.
  ...
  symmetry. apply beq_string_true_iff. Qed.
(** [] *)
...
Proof.
  intros. unfold t_update. apply functional_extensionality.
  intros x. destruct (beq_stringP x1 x).
  - destruct (beq_stringP x2 x).
    + rewrite <- e in e0. unfold not in H. apply H in e0. destruct e0.
    + reflexivity.
  - reflexivity. Qed.
(** [] *)
