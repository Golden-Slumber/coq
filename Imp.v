...
Proof.
  ...
  - destruct a2.
    + destruct n.
      * simpl. rewrite <- plus_n_O. apply IHa1.
...
Example test_optimize_minus0: 
  optimize_minus0 (AMinus (ANum 2) (ANum 0)) = ANum 2.
Proof. reflexivity. Qed.

Theorem optimize_minus0_sound: forall a,
...
Proof.
  ...
  - destruct a2.
    + destruct n.
      * simpl. assert ( aeval a1 - 0 = aeval a1) as H.
        { destruct (aeval a1). reflexivity. simpl. reflexivity. }
        rewrite H. apply IHa1.
      * simpl. rewrite IHa1. reflexivity.
    + simpl. simpl in IHa2. rewrite IHa2. rewrite IHa1. reflexivity.
    + simpl. simpl in IHa2. rewrite IHa2. rewrite IHa1. reflexivity.
    + simpl. simpl in IHa2. rewrite IHa2. rewrite IHa1. reflexivity. 
