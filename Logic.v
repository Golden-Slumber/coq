...
Fact not_implies_our_not : forall (P:Prop),
  ~ P -> (forall (Q:Prop), P -> Q).
Proof.
  intros. unfold not in H. apply H in H0. inversion H0. Qed.  
(** [] *)
...
Proof.
  ...
  unfold not in H0. apply H0 in H1. apply H1. Qed.
  (*
  intros P Q.  
  intros H.
  intros NQ.
...
Proof.
  ...
  - intros HR. apply H2 in HR. apply H1 in HR. apply HR. Qed.
(** [] *)
...
Proof.
  ...
  - intros [[HP1|HQ] [HP2|HR]].
    ...
    + left. apply HP1.
    + left. apply HP2.
    + right. apply and_intro. apply HQ. apply HR. Qed.
(** [] *) 
...
Proof.
  intros.
  unfold not.
  intros. destruct H0. apply H0 in H. apply H. Qed.
(** [] *)
...
Proof.
  ...
  - intros. simpl. split.
    ...
    + intros [[H1|H2]|H3].
      ...
      * right. apply IHl. right. apply H3. Qed.
...
Proof.
  ...
  - simpl. split.
    ...
    + intros [H1 H2]. intros x0. intros [H|H].
      * rewrite <- H. apply H1.
      * apply IHl in H. apply H. apply H2. Qed.
(** [] *)
...
Proof.
  ...
  - simpl. unfold tr_rev. simpl. rewrite <- IHl'. unfold tr_rev.
    rewrite tr_rev_append_correct. symmetry. 
    rewrite tr_rev_append_correct. rewrite <- app_assoc. simpl. reflexivity. Qed.
...
Proof.
  ...
  - rewrite evenb_S. destruct IHn'. destruct (evenb n') eqn : H1.
    + simpl. exists x. rewrite H. reflexivity.
    + simpl. exists (S x). rewrite H. simpl. reflexivity. Qed. 
(** [] *)
...
Theorem nat_eq : forall n1 n2 : nat,
  n1 = n2 -> S n1 = S n2.
Proof.
  intros.
...
Proof.
  ...
  - induction n1.
    ...
    + destruct n2.
      * intros. inversion H.
      * simpl. intros. apply nat_eq. apply IHn1. apply H.
  - intros H. rewrite H. rewrite <- beq_nat_refl. reflexivity. Qed.
...
Proof.
  ...
  - intros [eq1 eq2]. rewrite eq1. rewrite eq2. reflexivity. Qed.
...
Proof.
  ...
  - intros [H | H].
    ...
    + rewrite H. rewrite orb_commutative. simpl. reflexivity. Qed.
(** [] *)
...
Proof.
  ...
  - simpl. destruct y.
    + split.
      ...
      * intros. reflexivity.
    + split.
      * intros. apply IHx in H. unfold not. intros. inversion H0.
        rewrite H2 in H. unfold not in H. apply H. reflexivity.
      * intros. apply IHx. unfold not. intros. unfold not in H.
  ...
  - split.
    + destruct l2.
      ...
      * simpl. intros. apply andb_true_iff in H0. destruct H0. 
        apply H in H0. apply IHl' in H1. rewrite H0. rewrite H1. reflexivity.
    + destruct l2.
      * simpl. intros. inversion H0.
      * intros. rewrite <- H0. simpl. apply andb_true_iff. split.
        apply H. reflexivity. apply IHl'. reflexivity. Qed.
...
Proof.
  ...
  - split.
    + simpl. intros. apply andb_true_iff in H. destruct H. split.
      * apply H.
      * apply IHl'. apply H0.
    + simpl. intros. apply andb_true_iff. destruct H. split.
      * apply H.
...
Proof.
  intros.
  unfold not. intros H. apply H. right.
  intros. apply H. left. apply H0. Qed.
...
Proof.
  ...
  intros ex X P.
  intros H. intros x.
  specialize (ex(P x)). destruct ex.
  - apply H0.
  - unfold not in H. destruct H. exists x. unfold not in H0. apply H0. Qed.
